const CategoryCard = ({ category, onClick }) => {
  ...
  return (
    <div 
      ...
      className="group relative overflow-hidden rounded-xl sm:rounded-2xl cursor-pointer transform transition-all duration-300 hover:scale-105 active:scale-95"
    >
      {/* Gradient Border Effect */}
      <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 blur transition-all duration-500"></div>
      ...
      <div className="relative bg-gray-800/90 backdrop-blur-xl rounded-xl sm:rounded-2xl overflow-hidden border border-gray-700 group-hover:border-transparent transition-all duration-500">
        ...
        <div className="relative h-32 sm:h-36 md:h-40 lg:h-48 overflow-hidden">
          ...
          <div className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 md:top-3 md:right-3 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-pink-500 to-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center text-base sm:text-xl md:text-2xl shadow-2xl shadow-pink-500/50 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
            {icon}
          </div>
        ...
        <div className="relative p-2 sm:p-3 md:p-4 lg:p-5 bg-gradient-to-br from-gray-800 to-gray-900">
          <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-bold text-white mb-1 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:to-purple-400 group-hover:bg-clip-text transition-all duration-300 line-clamp-2">
            {category.name}
          </h3>
          ...
          {/* Decorative Corner */}
          <div className="absolute bottom-0 right-0 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gradient-to-tl from-purple-500/20 to-transparent rounded-tl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        </div>
      </div>
    </div>
  );
